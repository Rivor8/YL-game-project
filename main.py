...
load_image('wall_door_l1.png', tile=True)
load_image('wall_door_l2.png', tile=True)
load_image('corner1.png', tile=True)
load_image('corner2.png', tile=True)
load_image('corner3.png', tile=True)
load_image('corner4.png', tile=True)
